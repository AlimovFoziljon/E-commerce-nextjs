                                ...
                                <div className="flex-1 flex flex-col">
                                    <div className="flex-1">
                                        ...
                                        <div className="space-y-3 text-sm">
                                            <button onClick={handleClick} className="button w-full bg-blue-600 text-white border-transparent hover:border-blue-600 hover:bg-transparent hover:text-black">Add to cart</button>
                                            <button onClick={() => window.location.reload()} className="button w-full border-blue-600 text-black bg-transparent hover:bg-blue-600 hover:border-transparent hover:text-white">View full details</button>
                                        </div>
                                </div>
                            </div>
                        )}
